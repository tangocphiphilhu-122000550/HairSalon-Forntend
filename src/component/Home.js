...
const Home = () => {
  ...
  return (
    <div
      ...
      style={{
        background: "url('/backrougnfeedback.jpg') center/cover no-repeat", // Chuyển từ CSS sang inline
      }}
    >
      {/* Banner lớn */}
      <div
        className="banner"
        style={{
          background: "url('/banner.jpg') center/cover no-repeat", // Chuyển từ CSS sang inline
        }}
      >
      ...
      <section
        className="services"
        style={{
          background: "url('/kingkong.jpg') center/cover no-repeat", // Chuyển từ CSS sang inline
        }}
      >
      ...
      <section className="hairstyle-gallery">
        ...
        <p className="hairstyle-subtitle">
